...
//  rec104
//
//  Created by Saimanasa Juluru on 9/27/19.
//  Copyright © 2019 Saimanasa Juluru. All rights reserved.
//
...
public:
    ...
    bool movesInWith(Person& newRoomate) {
        ...
        if (this != &newRoomate){
            cout << "You cannot be own roomate." << endl;
            return false;
        }
        
        else if (roomie == nullptr && newRoomate.roomie == nullptr){
